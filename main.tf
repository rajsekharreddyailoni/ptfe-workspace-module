...
module "networking" {
  source  = "app.terraform.io/trainingraj/networking/azurerm"
  version = "0.12.0"
...
module "webserver" {
  source  = "app.terraform.io/trainingraj/webserver/azurerm"
  version = "0.12.1"
...
module "appserver" {
  source  = "app.terraform.io/trainingraj/appserver/azurerm"
  version = "0.12.1"
